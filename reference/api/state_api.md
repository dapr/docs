...
Actors don't support multiple state stores and require a transactional state store to be used with Dapr. Currently Mongodb, Redis, PostgreSQL, Azure SQL Server, and Azure CosmosDB implement the transactional state store interface.
