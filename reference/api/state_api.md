...
Actors don't support multiple state stores and require a transactional state store to be used with Dapr. Currently mongodb, redis, and CosmosDB implement the transactional state store interface.
