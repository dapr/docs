...
| DAPR1303 | Dapr.Workflow | Usage | Warning | The provided input type does not match the target workflow or activity input type |
| DAPR1304 | Dapr.Workflow | Usage | Warning | The requested output type does not match the target workflow activity output type |
