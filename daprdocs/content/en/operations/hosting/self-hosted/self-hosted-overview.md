...
You can use the [`dapr run` CLI command]({{< ref dapr-run.md >}}) to a Dapr sidecar process along with your application. Additional annotations and flags can be found [here]({{< ref arguments-annotations-overview.md >}}). 
