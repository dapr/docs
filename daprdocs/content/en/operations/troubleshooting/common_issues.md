...
- You may have not provided a `--components-path` with the Dapr `run` commands or not placed your components into the default components folder for your OS. Read [define a component]({{< ref "getting-started/tutorials/get-started-component.md" >}}) for more information.
