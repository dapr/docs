...
|--------------------|:--------:|:--------|---------|---------|---------|------------|
| Mar 26th 2026 | 1.17.3</br> | 1.17.0 | Java 1.17.0 </br>Go 1.14.2 </br>PHP 1.2.0 </br>Python 1.17.0 </br>.NET 1.17.5 </br>JS 3.6.0 </br>Rust 0.17.0 | 0.15.0 | Supported (current) | [v1.17.3 release notes](https://github.com/dapr/dapr/releases/tag/v1.17.3)   |
