...
| Service invocation will no longer provide a default content type header of `application/json` when no content-type is specified. You must explictly set a content-type header for service invocation if your invoked apps rely on this header. |                 1.7.0 |                    1.8.0 |
