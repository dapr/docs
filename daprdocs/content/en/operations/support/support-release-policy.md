...
|--------------------|:--------:|:--------|---------|---------|---------|------------|
| Apr 16th 2026 | 1.15.14</br>  | 1.15.2 | Java 1.15.2 </br>Go 1.12.0 </br>PHP 1.2.0 </br>Python 1.15.0 </br>.NET 1.15.4 </br>JS 3.5.2 </br>Rust 0.16.1 | 0.15.0 | Supported | [v1.15.14 release notes](https://github.com/dapr/dapr/releases/tag/v1.15.14) |
