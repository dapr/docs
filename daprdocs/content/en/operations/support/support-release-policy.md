...
|--------------------|:--------:|:--------|---------|---------|---------|------------|
| July 24th 2024 | 1.14.0</br>  | 1.14.0 | Java 1.11.0 </br>Go 1.10.0 </br>PHP 1.2.0 </br>Python 1.14.0 </br>.NET 1.14.0 </br>JS 3.3.0 | 0.14.0 | Supported (current) | [v1.14.0 release notes](https://github.com/dapr/dapr/releases/tag/v1.14.0) |
