...
| Actor App-Initiated Streams    |  [SubscribeActorEventsAlpha1 proto](https://github.com/dapr/dapr/blob/86440a8a624c8ceb6d8cf882682bcd34f6025772/dapr/proto/runtime/v1/dapr.proto#L125)    | N/A | Actor hosts open a single bidirectional gRPC stream to daprd and receive all actor callbacks (invoke, reminder, timer, deactivate) over that connection. Apps do not need to expose a server port. | [Actor app-initiated streams]({{% ref "actors-app-initiated-streams" %}}) | v1.18 |
