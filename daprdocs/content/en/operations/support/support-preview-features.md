...
| **Pluggable components** | Allows creating self-hosted gRPC-based components written in any language that supports gRPC. | N/A| [Pluggable components concept]({{<ref "components-concept.md#pluggable-components">}})| v1.9 |
