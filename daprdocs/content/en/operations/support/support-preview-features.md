...
| **--image-registry** flag with Dapr CLI| In standalone mode we can specify this flag to specify any private registry to pull various container images required to install Dapr| N/A | [init CLI command reference]({{<ref "dapr-init.md#self-hosted-environment" >}}) |
