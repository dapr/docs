...
| [**Configuration**]({{<ref "app-configuration-overview.md">}}) | `N/A` | Dapr offers a Configuration API that lets developers get and subscribe to application configuration items for Dapr supported configuration stores.
