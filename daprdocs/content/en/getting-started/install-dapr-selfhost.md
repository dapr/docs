...
If you're planning to build Dapr Workflow applications, you can install the [Diagrid Dashboard](https://docs.diagrid.io/references/dashboard/instructions) to visualize workflow state during local development:
