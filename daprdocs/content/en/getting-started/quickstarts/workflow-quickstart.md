...
- [Dapr and Dapr CLI installed and initialized]({{< ref install-dapr-cli.md >}}).
  * Run `dapr init`.
...
Navigate into the root and install the dependencies:
