...
| `--dapr-http-read-buffer-size` |                      | `4`                                                                                | Max size of read buffer in KB.This param limits the maximum header size.  Using bigger than default 4KB size headers should set this to a proper value.                                                                      |
### Examples
