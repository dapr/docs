...
| `--scheduler-host-address`      |                      | Linux/Mac: `$HOME/.dapr/components` <br/>Windows: `%USERPROFILE%\.dapr\components` | Run in any containers within your Docker network. Uses `<hostname>` or `<hostname>:<port>`. If the port is omitted, it will default to: <ul><li>Linux/MacOS: `50005`</li><li>Windows: `6050`</li></ul> |
