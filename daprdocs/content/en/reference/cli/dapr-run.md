...
Run Dapr and (optionally) your application side by side. A full list of arguments comparing daprd arguments, CLI arguments, and Kubernetes annotations can be found [here]({{< ref arguments-annotations-overview.md >}}).
