...
{{% codetab %}}
HashiCorp offer in depth guides on how to setup Consul for different hosting models. Check out the [Kubernetes guide here](https://learn.hashicorp.com/tutorials/consul/kubernetes-deployment-guide)
{{% /codetab %}}
