...
| queueEndpoint | N | Input/Output | Optional custom endpoint URL. This is useful for, e.g., "[production-style URLs](https://github.com/Azure/azurite#production-style-url)" when using the [Storage emulator](https://github.com/Azure/azurite) | `"https://accountName.queue.example.com:10001"` |
