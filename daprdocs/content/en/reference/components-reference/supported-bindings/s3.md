...
| `storageClass` | N | Output | The desired storage class for objects during the create operation | `STANDARD_IA` |
...
Optionally, provide a storage class while using the `create` operation with the following:
