...
| subscribeInitialPosition | N | Subscription position is the initial position which the cursor will be set when start consuming. Default: `"latest"` | `"latest"`, `"earliest"` |
