...
Because RabbitMQ ignores every argument but the name on a passive declaration, an exchange of any kind the broker supports can be used this way, including plugin-provided kinds.
