...
| username | Y | The user name to connect to the broker with | default
| password | Y | The password to connect to the broker with | default
| anonymous | N | To connect to the broker without credential validation. Only works if enabled | true
