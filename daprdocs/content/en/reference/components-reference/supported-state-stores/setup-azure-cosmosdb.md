...
CosmosDB has a [maximum document size of 2MB and maximum transaction size of 100 operations.](https://learn.microsoft.com/en-us/azure/cosmos-db/concepts-limits#per-request-limits).
