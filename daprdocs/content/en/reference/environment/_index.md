...
| DAPR_APP_API_TOKEN_HEADER | Dapr sidecar | The custom HTTP header or gRPC metadata name used to send `APP_API_TOKEN` to the application. It replaces the default `dapr-api-token` name. If unset or empty, the default name is used. |
