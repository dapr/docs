...
| not supported | `--image` | | `dapr.io/sidecar-image` | Dapr sidecar image. Default is `daprio/daprd:latest`. Use this when building your own custom image of Dapr and the Dapr sidecar will use this image instead of the default image. Also [to use alternative Dapr images]({{<ref "support-release-policy.md#build-variations" >}})  |
