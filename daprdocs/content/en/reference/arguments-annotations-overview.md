...
| not supported | `--image` | | `dapr.io/sidecar-image` | Dapr sidecar image. Default is daprio/daprd:latest. One scenario this can be used is when building your own custom image of `darpd.exe` and you want this launched by the Kubernetes Sidecar Injector service rather than the latest supported version |
