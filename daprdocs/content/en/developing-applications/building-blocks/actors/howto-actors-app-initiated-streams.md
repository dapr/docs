...
App                                     daprd (Dapr sidecar)
 |                                           |
 |-- SubscribeActorEventsAlpha1() ---------->|  open stream
 |                                           |
 |-- SubscribeActorEventsRequestInitialAlpha1 -->|  register actor types + config
 |<-- SubscribeActorEventsResponseInitialAlpha1 --|  ack (empty = success)
 |                                           |
 |<-- invoke_request (id="abc", method="x") --|  callback
 |-- invoke_response (id="abc", data=...) -->|  response
 |                                           |
 |<-- reminder_request (id="def") ----------|  callback
 |-- reminder_response (id="def") -------->|  ack
 |                                           |
 |<-- deactivate_request (id="ghi") --------|  callback
 |-- deactivate_response (id="ghi") ------->|  ack
```
