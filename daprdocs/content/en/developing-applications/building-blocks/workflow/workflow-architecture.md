...
See the [Reminder usage and execution guarantees]({{< ref workflow-architecture.md >}}) for more details on how the design of workflow actors may impact execution latency.
