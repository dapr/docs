...
Dapr allows users to keep their own proto services and work natively with gRPC. This means there are no SDKs or custom gRPC services needed to have Dapr service invocation work with gRPC apps. For more information, see the [how-to tutotial for Dapr and gRPC]({{< ref howto-invoke-services-grpc.md >}}). 
