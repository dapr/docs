...
For more information, read: [Declarative vs. Programmatic]({{< ref subscription-methods >}}).
...
The publish/subscribe API is located in the [API reference document]({{< ref pubsub_api.md >}}).
