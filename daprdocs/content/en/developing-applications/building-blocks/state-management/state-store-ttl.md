...
Let's say you have a TTL set at the database/container level. Many databases allow you to overwrite the TTL for a specific entity. You can tell it to explicitly _persist_ the given key. 
