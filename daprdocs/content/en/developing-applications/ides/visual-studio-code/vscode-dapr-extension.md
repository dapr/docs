...
* Adds a view container specifically for Dapr applications which when selected displays a tree view called "Applications" which shows locally-running Dapr applications.
...
* You can publish events to running applications you select in the "Applications" tree view.
* Allows you to specify both the topic and an optional payload.
...
### Debuggin Multiple Dapr Applications At The Same Time
...
### Dapr Community Call Demonstration
