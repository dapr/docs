...
| ------------------------------------------------------------ | -------------------------- | ------------------------------------------------------------------------------------------------ |
| [v1.17](https://github.com/dapr/docs) (primary)               | https://docs.dapr.io       | Latest Dapr release documentation. Typo fixes, clarifications, and most documentation goes here. |
| [v1.18](https://github.com/dapr/docs/tree/v1.18) (pre-release) | https://v1-18.docs.dapr.io/ | Pre-release documentation. Doc updates that are only applicable to v1.18+ go here.                |
